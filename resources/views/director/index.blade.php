            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ url('director/create') }}" class="btn btn-outline-success">
                                ...
                                <tbody>
                                    @foreach ($employees as $employee)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url("director/$employee->id_employee/edit") }}"
                                                    class="btn btn-outline-primary">
                                                    <i class="fa fa-edit"></i>&nbsp; Edit
                                                </a>
                                                <a href="{{ url("director/$employee->id_employee/delete") }}"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ url("director/$employee->id_employee/delete") }}" class="btn btn-primary">
                                &nbsp; Confirm
                            </a>
                        </div>
                    </div>
