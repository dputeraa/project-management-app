    ...
    <div class="col-lg-14">
        <div class="card">
            <div class="card-body">
                ...
                <div id="pay-invoice">
                    <div class="card-body">
                        <form action="{{ url("project/$project->id_project") }}" method="post" novalidate="novalidate">
                            @method('patch')
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="description_project" class=" form-control-label mb-1">Description
                                    Project</label>
                                <textarea name="description_project" id="description_project" rows="3" class="form-control">{{ $project->description_project }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input id="date_of_completion" name="date_of_completion" type="date" class="form-control"
                                ...
                                <select class="form-control" name="status_id" aria-label="Default select example">
                                    ...
                                    @foreach ($status as $sts)
                                        <option value="{{ $sts->id_status }}"
                                            {{ $sts->id_status == $project->status_id ? 'selected' : '' }}>
                                            {{ $sts->name_status }}
                                        </option>
                                    @endforeach
                                </select>
